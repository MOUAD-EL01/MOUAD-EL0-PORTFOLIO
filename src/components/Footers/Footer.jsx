...
const Footer = () => {
  return (
    <div>
      <footer class="bg-[#202233] rounded-lg m-2 ">
        <div class="w-full justify-center  p-4 md:flex md:items-center md:justify-between">
          <span class="text-xl flex justify-center  text-white text-center ">
            © 2023 . All Rights Reserved.
          </span>
          <ul class="flex justify-center items-center text-xl font-medium text-white  sm:mt-0">
            <li>
              <a
